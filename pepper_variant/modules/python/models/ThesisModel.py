...
from pepper_variant.modules.python.Options import CANDIDATE_WINDOW_SIZE

learning_rate = 0.001
weight_deacy = 0.00001
step_size = 10000
epochs = 2
class TransducerGRU(nn.Module):
    def __init__(self, image_features=26, gru_layers=1, hidden_size=256, num_classes_type=3, bidirectional=True):
        ...
        self.linear_1 = nn.Linear((self.lstm_2_hidden_size * 2) * (CANDIDATE_WINDOW_SIZE + 1), self.linear_1_size)
